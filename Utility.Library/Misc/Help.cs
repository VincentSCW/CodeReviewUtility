...
namespace HelpProvider
{
    ...
    public static class HelpProvider
    {
        ...
        public static extern int HtmlHelp(HandleRef hwndCaller, [MarshalAs(UnmanagedType.LPTStr)] string pszFile, NativeHtmlHelpCommand uCommand, [MarshalAs(UnmanagedType.LPTStr)] string dwData);



        public static void ShowIndex() //HandleRef caller)
        {
            HandleRef r = default(HandleRef);
            HtmlHelp(r, FileName, NativeHtmlHelpCommand.TableOfContents, "");
        }
    }
